                  ...
                  children: [
                    ...
                    Column(
                      children: [
                                    ...
                                    padding: EdgeInsets.symmetric(
                                        vertical:
                                            MediaQuery.of(context).size.width *
                                                6 /
                                                100),
                                    child: WeatherStatus('temperature.png',
                                        'Temperature', '26', 4 / 10))
                              ],
                            ),
                            Container(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  boxShadow: [
                                    BoxShadow(
                                      color: Colors.black.withOpacity(30 / 100),
                                      spreadRadius: 0,
                                      blurRadius: 2,
                                      offset: Offset(
                        ...
                        WeatherStatus('pressure.png', 'Pressure', '26', 7 / 10),
                        WeatherStatus('wind.png', 'Wind', '26', 6 / 10),
                        WeatherStatus('humidity.png', 'Humidity', '26', 5 / 10)
                      ],
                    ),
                  ],
                )
